...
class FacePredictor():
    def __init__(self):
        print("INSIDE THE FacePredictor class")
        try:
            ...
            # self.model_filename = model placed here, not needed
            # # Initialize detector
            self.detector = MTCNN()
    ...
    def notify_client(self, name):
        # Define the URL of the updateDatabase endpoint
        url = 'http://127.0.0.1:8080/updateDatabase'

        # Send a POST request to the endpoint with the name as JSON data
    ...
    def detectFace(self):
        ...
        for index in range(10):  # Try up to index 10
            ...
            if cap.isOpened():
                ...
                print("No camera found at index:", index)
                ...
                if len(bboxes) != 0:
                    ...
                    for bboxe in bboxes:
                        ...
                        if cos_similarity < cosine_threshold and proba > proba_threshold:
                            ...
                            # Notify the client to update the database
                            response = self.notify_client(name)
